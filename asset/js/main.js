...
var countDownDate = new Date("August 10, 2025 09:00:00").getTime();
...
document
  ...
  .addEventListener("click", function () {
    // Event details
    const title = "Pernikahan Muhammad Zanwadi & Ena Irawati";
    const description =
      "Kami mengundang Anda untuk berbagi kebahagiaan di hari pernikahan kami";
    const location = "Alamat aik bukak batu ngerenseng lauk";
    const startDate = new Date("2025-08-10T09:00:00");
    const endDate = new Date("2025-08-10T12:00:00");
